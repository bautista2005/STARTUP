...
export const styles = {
    ...
    authContainer: { backgroundColor: 'white', padding: '2.5rem', borderRadius: '1.5rem', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', maxWidth: '450px', margin: '0 auto' },
    authTitle: { margin: '1rem 0 0.25rem 0', fontSize: '2rem', fontWeight: '700', color: '#3B82F6' },
    ...
    input: { width: '100%', padding: '0.75rem 0.75rem 0.75rem 2.5rem', fontSize: '1rem', border: '2px solid #d1d5db', borderRadius: '0.75rem', boxSizing: 'border-box', outline: 'none' },
    ...
    authToggle: { background: 'none', border: 'none', color: '#3B82F6', cursor: 'pointer', marginTop: '1rem', padding: 0, fontWeight: 600 },
